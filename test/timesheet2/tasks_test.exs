defmodule Timesheet2.TasksTest do
  ...
  describe "tasks" do
    ...
    @valid_attrs %{approved: true, hours: 42, job_code: "some job_code", manager: 42}
    @update_attrs %{approved: false, hours: 43, job_code: "some updated job_code", manager: 43}
    @invalid_attrs %{approved: nil, hours: nil, job_code: nil, manager: nil}
